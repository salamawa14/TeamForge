...
document.addEventListener('DOMContentLoaded', () => {
  ...
  newPass?.addEventListener('input', () => {
    ...
    const lvls=[{w:'0%',c:'var(--border)',t:''},{w:'25%',c:'var(--red)',t:'Weak'},{w:'50%',c:'var(--amber)',t:'Fair'},{w:'75%',c:'var(--teal)',t:'Good'},{w:'100%',c:'var(--green)',t:'Strong'}];
    bar.style.width=lvls[s].w; bar.style.background=lvls[s].c;
    lbl.textContent=lvls[s].t; lbl.style.color=lvls[s].c;
  });
});